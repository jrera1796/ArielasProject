...
const ClientBooking = () => {
  ...
  // Handle booking form submission: validate and move to review step.
  ...
  // Handle review submission: call backend to create PaymentIntent and booking.
    ...
    try {
      const res = await fetch('/api/create-payment-intent', {
        ...
        body: JSON.stringify({
          ...
          amount: SERVICE_COSTS[bookingData.serviceType] || 0
        })
      });
        ...
        <div className="new-booking">
          ...
          {step === 2 && (
            <div className="review-booking">
              ...
              <p><strong>Cost:</strong> ${SERVICE_COSTS[bookingData.serviceType] ? (SERVICE_COSTS[bookingData.serviceType] / 100).toFixed(2) : '0.00'}</p>
              <p>
                <strong>Pet:</strong> {bookingData.petOption === 'select'
          ...
          {step === 3 && (
            <form className="payment-form" onSubmit={handlePaymentSubmit}>
              <h2>Payment</h2>
              <CardElement />
              <button className="payment-submit-btn" type="submit" disabled={!stripe}>Pay Now</button>
              {error && <p className="error-msg">{error}</p>}
            </form>
          )}
